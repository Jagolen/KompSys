...
r2=linspace(1,L/2,100);    % radius where the particles move towards each other
...
for eta = 1:numel(r2)
    ...
    closenessres(eta) = mean(closeness(end/2:end));
end

if ~ makemovie
    plot(r2, closenessres)
    xlabel("r_2")
    ylabel("Score")
    title("Plot of how the score changes based on r_2")
end
